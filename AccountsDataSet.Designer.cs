...
namespace WindowsFormsApp2 {
    ...
    public partial class AccountsDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CarsRow AddCarsRow(string manyfactory, string model, int releaseyear, string carbody, int hp) {
...
namespace WindowsFormsApp2.AccountsDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cars] WHERE (([Id] = @Original_Id) AND ([manyfactory] = @Original_manyfactory) AND ([model] = @Original_model) AND ([releaseyear] = @Original_releaseyear) AND ([carbody] = @Original_carbody) AND ((@IsNull_hp = 1 AND [hp] IS NULL) OR ([hp] = @Original_hp)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([manyfactory], [model], [releaseyear], [carbody], [hp])" +
                " VALUES (@manyfactory, @model, @releaseyear, @carbody, @hp);\r\nSELECT Id, manyfac" +
                "tory, model, releaseyear, carbody, hp FROM Cars WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [manyfactory] = @manyfactory, [model] = @model, [releaseyear] = @releaseyear, [carbody] = @carbody, [hp] = @hp WHERE (([Id] = @Original_Id) AND ([manyfactory] = @Original_manyfactory) AND ([model] = @Original_model) AND ([releaseyear] = @Original_releaseyear) AND ([carbody] = @Original_carbody) AND ((@IsNull_hp = 1 AND [hp] IS NULL) OR ([hp] = @Original_hp)));
SELECT Id, manyfactory, model, releaseyear, carbody, hp FROM Cars WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, manyfactory, model, releaseyear, carbody, hp FROM dbo.Cars";
        ...
        public virtual int Delete(int Original_Id, string Original_manyfactory, string Original_model, int Original_releaseyear, string Original_carbody, global::System.Nullable<int> Original_hp) {
        ...
        public virtual int Insert(string manyfactory, string model, int releaseyear, string carbody, global::System.Nullable<int> hp) {
            if ((manyfactory == null)) {
        ...
        public virtual int Update(string manyfactory, string model, int releaseyear, string carbody, global::System.Nullable<int> hp, int Original_Id, string Original_manyfactory, string Original_model, int Original_releaseyear, string Original_carbody, global::System.Nullable<int> Original_hp, int Id) {
            if ((manyfactory == null)) {
                throw new global::System.ArgumentNullException("manyfactory");
            }
            else {
            ...
            if ((Original_manyfactory == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_manyfactory));
            }
            if ((Original_model == null)) {
                throw new global::System.ArgumentNullException("Original_model");
            }
            ...
            if ((Original_carbody == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_carbody));
            }
            if ((Original_hp.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_hp.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string manyfactory, string model, int releaseyear, string carbody, global::System.Nullable<int> hp, int Original_Id, string Original_manyfactory, string Original_model, int Original_releaseyear, string Original_carbody, global::System.Nullable<int> Original_hp) {
            return this.Update(manyfactory, model, releaseyear, carbody, hp, Original_Id, Original_manyfactory, Original_model, Original_releaseyear, Original_carbody, Original_hp, Original_Id);
        }
    }
